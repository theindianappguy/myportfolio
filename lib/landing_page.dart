...
import 'package:myportfolio/data/general_data.dart';
import 'package:myportfolio/model/testimonial_model.dart';
import 'package:myportfolio/other/responsive_widget.dart';
...
class ProjectsTile extends StatefulWidget {
  String title, description, buttonText, projectUrl, techStack;
  bool isSmall = true;
...
class TestimonialTile extends StatefulWidget {
  String description, buttonText, creditsUrl,name;
  bool isSmall = true;
